...
export class default1684440500165 implements MigrationInterface {
    name = 'default1684440500165'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` int NOT NULL AUTO_INCREMENT, \`userName\` varchar(100) NOT NULL, \`userPosition\` varchar(25) NOT NULL, \`userEmail\` varchar(70) NOT NULL, \`userPassword\` varchar(100) NOT NULL, \`userType\` varchar(70) NOT NULL, \`icone\` varchar(255) NOT NULL, UNIQUE INDEX \`IDX_9047b2d58f91586f14f0cf44a4\` (\`userEmail\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`group\` (\`id\` int NOT NULL AUTO_INCREMENT, \`groupType\` varchar(80) NOT NULL, \`groupName\` varchar(80) NOT NULL, \`groupDescription\` varchar(100) NOT NULL, \`cliente\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`call\` (\`id\` int NOT NULL AUTO_INCREMENT, \`callEmail\` varchar(255) NOT NULL, \`callType\` varchar(8) NOT NULL, \`callTitle\` varchar(80) NOT NULL, \`callDescription\` varchar(255) NOT NULL, \`callPriority\` varchar(10) NULL, \`callStatus\` varchar(255) NULL, \`callDateCreate\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`callDateFinalization\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`HpDescription\` varchar(255) NOT NULL, \`avaliar\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
