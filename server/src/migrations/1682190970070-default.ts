...
export class default1682190970070 implements MigrationInterface {
    name = 'default1682190970070'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "committee" ("id" integer NOT NULL, "comiImpactCto" integer, "comiImpactHp" integer, "comiCostSquad" integer, "comiRiskRt" integer, "comiRiskCso" integer, "callId" integer, CONSTRAINT "PK_29569bbabae77e56711f2310563" PRIMARY KEY ("id"))`);
