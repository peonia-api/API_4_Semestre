...
export class default1682963491898 implements MigrationInterface {
    name = 'default1682963491898'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`committee\` (\`id\` int NOT NULL, \`comiImpactCto\` int NULL, \`comiImpactHp\` int NULL, \`comiCostSquad\` int NULL, \`comiRiskRt\` int NULL, \`comiRiskCso\` int NULL, \`callId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`groupToUser\` (\`id\` int NOT NULL AUTO_INCREMENT, \`groupId\` int NULL, \`userId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`groupToCall\` (\`id\` int NOT NULL AUTO_INCREMENT, \`groupId\` int NOT NULL, \`callId\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
