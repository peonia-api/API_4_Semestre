...
function ListagemUser() {
  ...
  const filteredData = data.filter(
    ...
    item.userPosition.toLowerCase().includes(searchQuery.toLowerCase())
          ...
          <Container className="px-2 mb-5">
            ...
            <Container>
              <div className="d-flex align-items-center justify-content-between mt-4 Margin" >
                <button type="button" className="btn btn-form resp" onClick={() => window.location.href = '/cadastroUsuario'}>Adicionar Usuário
