        ...
        <div className='d-flex flex-center flex-column flex-column-fluid hf-spacing px-2 mt-5'>
            ...
            >
                ...
                <div className="drop-comite">
                    ...
                    <select className="form-control bg-transparent" placeholder="Análise de Impacto - CTO" 
                        autoComplete="off" value={comiteCto} onChange={(e) => setcomiteCto(e.target.value)} >
